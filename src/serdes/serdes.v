...
//Device: GW5AT-15
//Device Version: B
//Created Time: Tue Apr 28 17:09:47 2026

module SerDes_Top (RoraLink_8B10B_Top_sys_reset_o, RoraLink_8B10B_Top_user_tx_ready_o, RoraLink_8B10B_Top_hard_err_o, RoraLink_8B10B_Top_channel_up_o, RoraLink_8B10B_Top_lane_up_o, RoraLink_8B10B_Top_gt_pcs_tx_clk_o, RoraLink_8B10B_Top_gt_pll_lock_o, RoraLink_8B10B_Top_user_clk_i, RoraLink_8B10B_Top_init_clk_i, RoraLink_8B10B_Top_reset_i, RoraLink_8B10B_Top_user_pll_locked_i, RoraLink_8B10B_Top_user_tx_data_i, RoraLink_8B10B_Top_user_tx_strb_i, RoraLink_8B10B_Top_user_tx_valid_i, RoraLink_8B10B_Top_user_tx_last_i, RoraLink_8B10B_Top_tx_aligned_i, RoraLink_8B10B_Top_tx_bonded_i, RoraLink_8B10B_Top_tx_verify_i, RoraLink_8B10B_Top_tx_reset_i, RoraLink_8B10B_Top_gt_reset_i, RoraLink_8B10B_Top_gt_pcs_tx_reset_i);
...
input RoraLink_8B10B_Top_tx_aligned_i;
input RoraLink_8B10B_Top_tx_bonded_i;
input RoraLink_8B10B_Top_tx_verify_i;
input RoraLink_8B10B_Top_tx_reset_i;
...
RoraLink_8B10B_Top RoraLink_8B10B_Top_inst (
    ...
    .tx_aligned_i(RoraLink_8B10B_Top_tx_aligned_i),
    .tx_bonded_i(RoraLink_8B10B_Top_tx_bonded_i),
    .tx_verify_i(RoraLink_8B10B_Top_tx_verify_i),
    .tx_reset_i(RoraLink_8B10B_Top_tx_reset_i),
